const requests = require("./pix_request");
  ...
  async create_payment(value, time = 30) {
    ...
    this.response = await requests.requests({
      ...
      json: {
        ...
        description: "PixAuto By Zultra",
        payment_method_id: "pix",
        payer: {
          email: "viniciusonezio35@gmail.com",
    ...
    logger.info(`[ PAY ] - Pagamento criado (${this.payment_id}) (R$${value})`);

    return {
      payment_id: this.payment_id,
      copy_paste: this.payment.point_of_interaction.transaction_data.qr_code,
      qr_code:
        this.payment.point_of_interaction.transaction_data.qr_code_base64,
    };
  }
